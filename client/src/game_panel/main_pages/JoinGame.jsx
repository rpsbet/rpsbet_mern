    ...
    render() {
        return (
            <>
                ...
                {this.props.roomInfo.game_type === 'Quick Shoot' && <QuickShoot join={this.join} user_id={this.props.user_id} creator_id={this.props.roomInfo.creator_id} qs_game_type={this.props.roomInfo.qs_game_type} />}
            </>
        );
    }
}
