            ...
            <>
                ...
                {this.props.roomInfo.game_type === 'Spleesh!' && 
                    <Spleesh 
                        ...
                        is_private={this.props.roomInfo.is_private} 
                    />}
                {this.props.roomInfo.game_type === 'Mystery Box' && this.props.roomInfo.box_list.length > 0 && 
                    <MysteryBox 
                        join={this.join} 
                ...
                {this.props.roomInfo.game_type === 'Brain Game' && 
                    <BrainGame 
                        ...
                        user_id={this.props.user_id} 
                        creator_id={this.props.roomInfo.creator_id} 
                        joined_count={this.props.roomInfo.game_log_list.length ? this.props.roomInfo.game_log_list.length : 0} 
                        is_private={this.props.roomInfo.is_private} 
                    />}
