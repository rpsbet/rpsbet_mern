            ...
            <div className={this.props.isDarkMode ? 'dark_mode' : ''}>
				...
				<div className="modal-body edit-modal-body terms-modal-body">
                    <div>
                        ...
                        <br/>
                        <h5>1.2 License</h5>
                        Unless otherwise stated, RPS Bet and/or its licensors own the intellectual property rights for all material on RPS Bet. All intellectual property rights are reserved. You may access this from RPS Bet for your own personal use subjected to restrictions set in these terms and conditions.<br/>
                        <br/>
                        You must not:<br/>
                        <br/>
                        Republish material from RPS Bet<br/>
                        Sell, rent or sub-license material from RPS Bet<br/>
                        Reproduce, duplicate or copy material from RPS Bet<br/>
                        Redistribute content from RPS Bet<br/>
                        ...
                        USE OF THE SERVICES IS AT YOUR SOLE RISK. THEY ARE PROVIDED ON AN “AS IS” BASIS. TO THE EXTENT PERMITTED BY APPLICABLE LAW, RPS BET, THE RPS BET CORPORATE FAMILY, AND THE RPS BET AFFILIATES MAKE NO WARRANTIES, CONDITIONS, OR OTHER TERMS OF ANY KIND, EITHER EXPRESS OR IMPLIED, ABOUT THE SERVICES. RPS Bet, THE RPS Bet CORPORATE FAMILY, AND THE RPS BET AFFILIATES DISCLAIM ANY WARRANTIES OF TITLE OR IMPLIED WARRANTIES, CONDITIONS, OR OTHER TERMS OF NON-INFRINGEMENT, MERCHANTABILITY, QUIET ENJOYMENT, OR FITNESS FOR A PARTICULAR PURPOSE.<br/>
                        ...
                        These limitations/exclusions to do not apply to users located in the EEA. For those users, if RPS Bet fails to comply with these Terms, RPS Bet is responsible for loss or damage you suffer that is a foreseeable result of RPS Bet’s breach of these Terms or is a result of RPS Bet’s negligence, but RPS Bet is not responsible for any loss or damage that is not foreseeable. Loss or damage is foreseeable if it was an obvious consequence of our breach or if it was contemplated by you and RPS Bet at the time we entered into these Terms.<br/>
                        <br/>
                        <h5>9.0 Bots/Artificial Intelligence</h5>
                        RPS Bet is to be completely bot-free and purely human vs. human. The below terms will apply whether any software or bot activity is or has been used in conjunction with the games client.<br/>
                        RPS Bet prohibits the use any use of bot software or artificial intelligence by players, whether commercially obtained or privately developed.<br/>
                        RPS Bet will actively monitor and look for such software on a player’s device, by registering the player consents to such software being searched for, and will not interfere with any of the detection mechanisms.<br/>
                        <br/>
                        <h5>10.0 One Account per Player</h5>
                        Players may open only one account with RPS Bet. Players must not attempt to bypass any of the restrictions which prevent the creation and/or use of multiple accounts.<br/>
                        <br/>
                        ...
                        RPS Bet prohibits activities designed to give a player an unfair advantage even if such play is allowed within a strict interpretation of - or a loophole in - the rules. Any play considered conventionally unethical or unfair is prohibited.<br/>
                        <br/>
                        <h5>14.0 Problem Gamblers</h5>
                        Anyone with a gambling problem must not open an account with, or play on, RPS Bet. Should a player discover they have a gambling problem they should inform RPS Bet and cease playing immediately.<br/>
                        <br/>
                        <h5>15.0 Locked/Closed Accounts</h5>
                        RPS Bet can, at their discretion, lock and/or permanently close a player’s account and without prior notice.<br/>
                        <br/>
                        <h5>16.0 Player Funds</h5>
                        Should a player be found in violation of the casino rules or RPS Bet’s Terms & Conditions, we reserve the right to seize all of the funds in the player’s account (and to reverse any pending withdrawals).<br/>
                        <br/>
