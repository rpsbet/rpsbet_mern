...
class RPS extends Component {
    ...
    onRemoveItem = (index) => {
        ...
        this.props.onChangeState({rps_list: newArray, bet_amount: bet_amount, max_return: bet_amount * 2 * 0.95});
    }
        ...
        return (this.props.step === 1 ?
            <div className="game-info-panel">
                ...
                <div id="rps-game-type-radio">
                    <span className={(this.props.rps_game_type === 0 ? " active" : "")} onClick={() => { this.props.onChangeState({rps_game_type: 0}); }}>Fixed</span>
            ...
            <div className="game-info-panel">
                <div className="rps-add-run-panel">
                    <div className="rps-add-run-form">
                        ...
                        />
                        <h3 className="game-sub-title">Select: Rock - Paper - Scissors! <button id="btn-add-run" className="other" onClick={this.onAddRun}>+ Add Run</button></h3>
                        <div id="rps-radio">
                                ...
                                {this.props.rps_list && this.props.rps_list.length > 0 ?
                                    this.props.rps_list.map((rps, index) => (
                                        <tr key={index}>
                                            ...
                                            <td><HighlightOffIcon onClick={() => this.onRemoveItem(index)} /></td>
                                        </tr>
                                    ))
                                    :
                                    <tr>
